      ...
      <div className="bg-white rounded-xl p-5 shadow-sm border" style={{ borderColor: 'var(--border)' }}>
        ...
        {recherche && (
          <div className="mt-3 space-y-2">
            ...
            {resultats.length > 8 && (
              <Link href={`/stock?q=${encodeURIComponent(recherche)}`} className="text-sm" style={{ color: 'var(--blue)' }}>
      ...
      {enAlerte.length > 0 && (
        <div className="bg-white rounded-xl p-5 shadow-sm border" style={{ borderColor: 'var(--border)' }}>
          <div className="flex items-center justify-between mb-3">
            ...
            <Link href="/alertes" className="text-sm font-medium" style={{ color: 'var(--blue)' }}>Voir tout →</Link>
          </div>
