    ...
    <div className="space-y-4">
      ...
      {loading ? (
        ...
        <div className="text-center py-12 bg-white rounded-xl border" style={{ borderColor: 'var(--border)' }}>
          ...
          {!recherche && (
            <Link href="/stock/composant/nouveau" className="mt-3 inline-block text-sm font-medium" style={{ color: 'var(--blue)' }}>
              ...
              {filtres.map((c, i) => {
                ...
                return (
                  ...
                  >
                    ...
                    <td className="px-4 py-3">
                      <Link href={`/stock/composant/${c.id}`} className="text-xs" style={{ color: 'var(--blue)' }}>Détail</Link>
                    </td>
                  </tr>
                )
              })}
